...
async function callAnthropic({ system, prompt, image }: GenerateOptions): Promise<GenerateResult> {
...
async function callOpenAI({ system, prompt, image }: GenerateOptions): Promise<GenerateResult> {
